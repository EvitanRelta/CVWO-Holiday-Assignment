...
export const DATA_REMOVE_TASK = 'data/removeTask';
...
export const DATA_REMOVE_CATEGORY = 'data/removeCategory';
...
export type DataRemoveCategory = {
    type: typeof DATA_REMOVE_CATEGORY;
    payload: number;
};
...
export type DataDispatchTypes = DataLoading | DataError | DataSetAllTasks
    ...
    | DataAppendCategory | DataAppendTag | DataEditCategory | DataRemoveCategory;
